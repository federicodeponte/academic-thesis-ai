# Academic Thesis AI - Logging System

This directory contains log files generated by the Academic Thesis AI system.

## Log Files

### `academic_thesis_ai.log`
...
```
academic_thesis_ai.log           # Current log
academic_thesis_ai.log.1         # Most recent backup
academic_thesis_ai.log.2         # 2nd most recent
academic_thesis_ai.log.3         # 3rd most recent
academic_thesis_ai.log.4         # 4th most recent
academic_thesis_ai.log.5         # Oldest backup
```
...
```bash
tail -f logs/academic_thesis_ai.log
```

### Count errors by type:
```bash
grep "ERROR" logs/academic_thesis_ai.log | cut -d'|' -f2 | sort | uniq -c
```

### Find failed scrapes:
```bash
grep "Failed to scrape" logs/academic_thesis_ai.log | wc -l
```
