...
- ✅ API calls to your chosen LLM provider (Gemini, Claude, or OpenAI)
  - You control which provider to use
  - Subject to their respective privacy policies
  - Required for AI-powered generation
- ✅ Citation database queries (Crossref, Semantic Scholar, PubMed, arXiv)
  - Public APIs for research paper metadata
  - No personal data transmitted
  - Standard HTTPS with SSL verification
...
**For researchers handling sensitive data:**
- Use local LLMs if needed (future feature)
