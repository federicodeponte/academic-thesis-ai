...
def sanitize_enhanced_output(
    ...
    Args:
        content: Full enhanced thesis markdown content
...
def sanitize_enhanced_file(
    ...
    """
    Sanitize an enhanced thesis file in place or to a new file.

    Args:
        input_path: Path to enhanced thesis file
...
def main():
    ...
    corrupted_file = project_root / "tests/outputs/opensource_thesis_backup_20251103_195312/16_enhanced_final.md"
