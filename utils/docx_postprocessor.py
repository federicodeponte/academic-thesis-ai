...
class DOCXPostProcessor:
    ...
    def process(self) -> bool:
        ...
        """
        try:
            print(f"\n📝 Post-processing DOCX: {self.docx_path.name}")
            print()
            ...
            print()
            print(f"✅ Post-processing complete: {self.docx_path}")
            return True
    ...
    def _insert_section_page_breaks(self):
        ...
        print(f"   ✓ Added page breaks before {count} major sections")
    ...
    def _insert_section_breaks(self):
        ...
        if main_content_para_index is None:
            print("   ⚠️  Could not find main content start (skipping section breaks)")
            return
        ...
        print(f"   ⚠️  Section breaks require manual insertion in Word")
        print(f"      (Insert → Break → Next Page before paragraph {main_content_para_index})")
    ...
    def _add_page_numbers(self):
        ...
        print(f"   ✓ Added page numbers to {len(self.doc.sections)} section(s)")
        print("   ℹ️  To add Roman numerals for front matter:")
        print("      1. Open in Word")
        print("      2. Insert → Break → Next Page (before Abstract)")
