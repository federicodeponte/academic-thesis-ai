...
<!-- PLACEHOLDER: Add hero demo GIF here (30-60 seconds, showing installation → verification → generation → PDF output) -->
...
<!-- PLACEHOLDER: Add 3-4 screenshots in a grid:
1. Terminal showing colorful verification output
...
**Watch:**
📹 [3-Minute Demo Video](https://youtube.com/...) | 🎮 [Try Interactive Demo →](https://colab.research.google.com/...)
