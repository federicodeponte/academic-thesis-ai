...
| Service | Cost |
|---------|------|
| OpenDraft | **${costs['gemini_flash_20k']}-${costs['gemini_pro_20k']}** |
...
<head>
    ...
    <title>OpenDraft - Generate Publication-Ready Theses in Minutes</title>
    <style>
        * {{
            margin: 0;
            padding: 0;
...
<body>
    <header>
        <div class="container">
            ...
            <a href="https://github.com/federicodeponte/opendraft" class="cta">Get Started on GitHub →</a>
        </div>
    </header>
            ...
            <div class="comparison-table">
                <table>
                    <thead>
                        <tr>
                            <th>Feature</th>
                            <th class="highlight">OpenDraft</th>
    ...
    <section>
        <div class="container">
            ...
            <p style="text-align: center; margin-bottom: 40px;">Real theses generated by OpenDraft</p>
    ...
    <footer>
        <div class="container">
            <p><strong>OpenDraft</strong></p>
            <p>Open source, transparent, and built for researchers</p>
            <p style="margin-top: 20px;"><a href="https://github.com/federicodeponte/opendraft" style="color: white;">GitHub</a> | <a href="docs/BENCHMARKS.html" style="color: white;">Benchmarks</a></p>
